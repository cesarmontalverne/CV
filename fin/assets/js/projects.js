...
const project_names = ["Hoosville", "Project Hunt", "Software Testing with Selenium", "WhatsApp Analyzer", "FUT Price Prediction",
...
class ReactProjects extends React.Component {
    ...
    allButtons = function () {
        return <div className="allbuttons">
            ...
            {this.indButton(project_names[8], 8)}
    ...
    contentSelector = function (sel) {
        switch (sel) {
            ...
            case 2:
                return (
                    <div className="">
                        <p className="test2 white">Software Testing with Selenium<br></br><a>2021</a></p>
                        <ul className="test3 white">
                            <li>Created test cases using Input Domain Testing and Base Case Coverage to test a simple web app.</li>
                            <li>Used Selenium to automate test cases.</li>
                            <li>Wrote a write up to explain each step of the process.</li>
                            <li><a target="_blank" href="projects.html#softwaretesting">Learn More</a></li>
                        </ul>
                    </div>
                )
            case 3:
